...
process_wait (tid_t child_tid)
{
  ...
  if(child_thd==NULL) {
    //use a hash table to trace the exit_code of dead child
    //the initial value is -1, which means no such child
    return (int)(cur->ecode_table[child_tid%ECODE_TABLE_SIZE]);
  }
