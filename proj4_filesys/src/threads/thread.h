...
struct thread
  {
    ...
    //char ecode_table[ECODE_TABLE_SIZE];
    int exit_code;
...
struct list* get_alllist(void);
struct file* getfile(int);
struct file_info* getfileinfo(int);
struct file_info{
  int fd;
